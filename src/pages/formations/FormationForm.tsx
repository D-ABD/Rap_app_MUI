...
export default function FormationForm({
  ...
  const safeValue = (options: NomId[], current: number | null | undefined) =>
    options.some((o) => String(o.id) === String(current)) ? String(current) : "";
      ...
      <Section icon={<AssignmentIcon color="primary" />} title="Informations principales">
        ...
        <Grid item xs={12} sm={6}>
          <FormControl fullWidth>
            ...
            <Select
              name="centre_id"
              value={safeValue(centres, values.centre_id)}
              onChange={handleChange}
              label="Centre"
              required
            >
        ...
        <Grid item xs={12} sm={6}>
          <FormControl fullWidth>
            ...
            <Select
              name="type_offre_id"
              value={safeValue(typeOffres, values.type_offre_id)}
              onChange={handleChange}
              label="Type d’offre"
              required
            >
        ...
        <Grid item xs={12} sm={6}>
          <FormControl fullWidth>
            ...
            <Select
              name="statut_id"
              value={safeValue(statuts, values.statut_id)}
              onChange={handleChange}
              label="Statut"
              required
            >
