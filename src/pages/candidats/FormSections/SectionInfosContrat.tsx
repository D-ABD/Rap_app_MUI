        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e =>
                setForm(f => ({ ...f, situation_avant_contrat: e.target.value || null }))
              }
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e =>
                setForm(f => ({ ...f, dernier_diplome_prepare: e.target.value || null }))
              }
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e =>
                setForm(f => ({ ...f, diplome_plus_eleve_obtenu: e.target.value || null }))
              }
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e =>
                setForm(f => ({ ...f, derniere_classe: e.target.value || null }))
              }
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e =>
                setForm(f => ({ ...f, intitule_diplome_prepare: e.target.value || null }))
              }
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e => setForm(f => ({ ...f, regime_social: e.target.value || null }))}
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={e =>
                setForm(f => ({ ...f, situation_actuelle: e.target.value || null }))
              }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, sportif_haut_niveau: e.target.checked }))
                  }
                />
              }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, equivalence_jeunes: e.target.checked }))
                  }
                />
              }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, projet_creation_entreprise: e.target.checked }))
                  }
                />
              }
